...
export default function NavBar() {
  const sections = useMemo<SectionId[]>(() => ["home", "about", "subscription", "contact"], []);
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      {
        root: null,
        // these margins make the "active" switch feel natural with a sticky header
    ...
    <header className="navWrap">
      <div className="navInner">
        ...
        <nav className="navLinks" aria-label="Primary">
          ...
          <a className={active === "subscription" ? "active" : ""} href="#subscription">
            Subscription
          </a>
